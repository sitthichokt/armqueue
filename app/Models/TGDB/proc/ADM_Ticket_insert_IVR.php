...
class ADM_Ticket_insert_IVR extends Model
{
    ...
    public function inserts()
    {
        $this->db->transOff();
        $this->db->transBegin();
        $storedProc = "EXEC ADM_Ticket_insert_IVR    @ScreenType= ?, @Ticket_Id= ?, @CustUser_Id= ?, @Who_Comment= ?, @Message_Status= ?, @Line_Message= ?, @Line_CreateDate= ?, @Line_Reply_Token= ?, @Line_Reply_Date= ?";
