...
class ADM6_Report_SLA_ManyFilter_EXCEL extends Model
{
    ...
    public function get()
    {
        $storedProc = "EXEC ADM6_Report_SLA_ManyFilter_EXCEL @AgentLogin_Id=?,@P_DateStart=?,@P_DateEnd=?,@TAB_NO=?,@CustSocial_Id=?,@AGroup_Id=?,@Agent_Id=?";
